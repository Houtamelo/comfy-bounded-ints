...
impl<const MIN: i8, const MAX: i8> Bound_i8<MIN, MAX> {
	...
	pub const fn new(mut inner: i8) -> Self {
	...
	#[cfg_attr(feature = "no_panic", no_panic::no_panic)]
	#[inline(always)] pub const fn bound_lower() -> i8 { MIN }

	#[cfg_attr(feature = "no_panic", no_panic::no_panic)]
	#[inline(always)] pub const fn bound_upper() -> i8 { MAX }
}
...
pub mod tests {
	...
	#[test] fn test_serde() { crate::types::test_macros::serde::test_signed_serde!(Bound_i8); }
}
