...
use crate::prelude::{Bound_isize, PadTo_i128, SqueezeTo_i128};
use crate::squeeze_to::SqueezeTo_isize;

impl<T, const MIN: isize, const MAX: isize> SubAssign<T> for Bound_isize<MIN, MAX> where T: SqueezeTo_i128 {
	#[inline(always)]
	fn sub_assign(&mut self, rhs: T) {
		self.set(i128::saturating_sub(self.get().pad_to_i128(), rhs.squeeze_to_i128()).squeeze_to_isize());
	}
}
