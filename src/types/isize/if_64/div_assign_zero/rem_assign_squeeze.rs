...
impl<T, const MIN: isize, const MAX: isize> RemAssign<T> for Bound_isize<MIN, MAX> where T: SqueezeTo_i128 {
	/// # Panics
	/// If rhs is 0.
	/// 
	...
	fn rem_assign(&mut self, rhs: T) {
		self.set(i128::rem(self.pad_to_i128(), rhs.squeeze_to_i128()).squeeze_to_isize());
	}
}
