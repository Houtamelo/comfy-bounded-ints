...
impl<T, const MIN: usize, const MAX: usize> DivAssign<T> for Bound_usize<MIN, MAX> where T: SqueezeTo_i128 {
	/// # Panics
	/// If rhs is 0.
	/// 
	...
	fn div_assign(&mut self, rhs: T) {
		self.set(i128::saturating_div(self.pad_to_i128(), rhs.squeeze_to_i128()).squeeze_to_usize());
	}
}
