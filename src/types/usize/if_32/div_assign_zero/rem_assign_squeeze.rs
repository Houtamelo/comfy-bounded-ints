...
impl<T, const MIN: usize, const MAX: usize> RemAssign<T> for Bound_usize<MIN, MAX> where T: SqueezeTo_i64 {
	/// # Panics
	/// If rhs is 0.
	/// 
	...
	fn rem_assign(&mut self, rhs: T) {
		self.set(i64::rem(self.pad_to_i64(), rhs.squeeze_to_i64()).squeeze_to_usize());
	}
}
