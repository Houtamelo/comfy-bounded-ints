...
impl<T, const MIN: usize, const MAX: usize> SubAssign<T> for Bound_usize<MIN, MAX> where T: SqueezeTo_i64 {
	#[inline(always)]
	fn sub_assign(&mut self, rhs: T) {
		self.set(i64::saturating_sub(self.get().pad_to_i64(), rhs.squeeze_to_i64()).squeeze_to_usize());
	}
}
